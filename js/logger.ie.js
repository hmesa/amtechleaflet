(function (window) {
    ...
    /**
             ...
             */
    var Logger = window.Class.extend({
        init: function (loglevel, logFcn) {
         ...
         * 
         */
        _log: function (/* level, msgpart0 [, msgpart1 [, msgpart2...]] */) {
        ...
        withFixExecInfo: function (param1, param2) {
            var sourceLogger = this;

            var FixLogger = Logger.extend({
                init: function (logLevel) {
                    this._super(sourceLogger.logLevel);
                },
